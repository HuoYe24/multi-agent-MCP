...
class DocumentChuncker:
    ...
    def __create_child_chunks(self, all_parent_pairs, all_child_chunks, parent_chunks, doc_path, source_name=None):
        source_name = source_name or str(doc_path.stem)+".pdf"
